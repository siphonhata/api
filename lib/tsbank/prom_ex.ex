defmodule Tsbank.PromEx do
  ...
  3. Update your `endpoint.ex` file to expose your metrics (or configure a standalone
     ...
     ```
     defmodule TsbankWeb.Endpoint do
       use Phoenix.Endpoint, otp_app: :tsbank

       ...

       plug PromEx.Plug, prom_ex_module: Tsbank.PromEx
  ...
  def plugins do
    [
      ...
      Plugins.Application,
      Plugins.Beam,
      {Plugins.Phoenix, router: TsbankWeb.Router, endpoint: TsbankWeb.Endpoint},
      Plugins.Ecto
      # Plugins.Oban,
  ...
  def dashboards do
    [
      ...
      # {:tsbank, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
